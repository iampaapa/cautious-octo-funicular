...
3. **Initial Setup**
   - **Download Dependencies**: Please download the following folder from this link; https://drive.google.com/drive/folders/15p_1zao2OU7gpJ3Xw2GWezFvPcBqqddx?usp=drive_link. Unzip it and move all the folders into the resources folder.
